...
def get_default_CNN_model(
    ...
    augment_fn = tf.keras.Sequential([#tf.keras.layers.RandomRotation(0.2,0.3), 
    ...
    model = CustomSequential(
        [
            ...
            Conv2D_manual(16,(3,3),strides=(1,1),activation='relu',padding='same'),
            ...
            # Conv2D(64,kernel_size=2,strides=1,activation='relu',padding='same'),
            # BatchNormalization(),


            Conv2D(128,kernel_size=2,strides=1,activation='relu',padding='same'),
            tf.keras.layers.MaxPool2D(2,2),
            BatchNormalization(),
            ...
            # Conv2D_manual(32, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', input_shape=(32, 32, 3)),
            # BatchNormalization(),
